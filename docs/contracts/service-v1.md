...
The same privileged store accepts a revalidated transport-health, heartbeat or
low-battery transition. It compares the expected prior state identity inside
