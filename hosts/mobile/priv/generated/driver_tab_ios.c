...
#endif
#ifdef MOB_STATIC_EMLX_NIF
void *emlx_nif_nif_init(void);
#endif
...
#endif
void *mob_notify_nif_nif_init(void);
void *wotex_ble_central_nif_nif_init(void);
void *wotex_secure_store_nif_nif_init(void);
...
#endif
#ifdef MOB_STATIC_EMLX_NIF
    {emlx_nif_nif_init,     0, THE_NON_VALUE, NULL},
#endif
#ifdef MOB_STATIC_NX_EIGEN_NIF
...
#endif
    {mob_notify_nif_nif_init,0, THE_NON_VALUE, NULL},
    {wotex_ble_central_nif_nif_init,0, THE_NON_VALUE, NULL},
    {wotex_secure_store_nif_nif_init,0, THE_NON_VALUE, NULL},
