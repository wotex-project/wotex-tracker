...
extern fn wotex_ble_central_nif_nif_init() callconv(.c) ?*anyopaque;
extern fn wotex_secure_store_nif_nif_init() callconv(.c) ?*anyopaque;
...
const base_nifs = [_]ErtsStaticNif{
    ...
    .{ .nif_init = wotex_ble_central_nif_nif_init, .is_builtin = 0, .nif_mod = THE_NON_VALUE, .entry = null },
    .{ .nif_init = wotex_secure_store_nif_nif_init, .is_builtin = 0, .nif_mod = THE_NON_VALUE, .entry = null },
};
