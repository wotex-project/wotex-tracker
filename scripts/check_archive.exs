...
required_files =
  case Mix.Project.config()[:app] do
    ...
    :wotex_tracker_service ->
      ~w(mix.exs README.md LICENSE NOTICE lib/wotex/tracker/service/store.ex lib/wotex/tracker/service/forward_queue.ex lib/wotex/tracker/service/http/server.ex priv/schema/1.sql priv/schema/1-to-2.sql priv/schema/2.sql priv/openapi/v1.json)
  end
